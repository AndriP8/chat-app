...
export const ScrollToBottomButton = ({ onClick, unreadCount = 0 }: ScrollToBottomButtonProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="absolute right-4 bottom-20 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-blue-500 text-white shadow-lg transition-all hover:bg-blue-600 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 md:right-8 md:bottom-8"
      aria-label={
