...
export const conversationParticipants = pgTable(
  ...
  (table) => ({
    ...
    conversation_idx: index("conversation_participants_conversation_idx").on(
...
export const messages = pgTable(
  ...
  (table) => ({
    conversation_idx: index("message_conversation_idx").on(
      table.conversation_id,
    ),
...
export const draftMessages = pgTable(
  ...
  (table) => ({
    conversation_idx: index("draft_message_conversation_idx").on(
      table.conversation_id,
    ),
...
export const sendMessageRequests = pgTable(
  ...
  (table) => ({
    ...
    last_sent_at_idx: index("send_message_request_last_sent_at_idx").on(
      table.last_sent_at,
    ),
  }),
);
...
export const sendMessageRequestsRelations = relations(
  sendMessageRequests,
  ({ one }) => ({
